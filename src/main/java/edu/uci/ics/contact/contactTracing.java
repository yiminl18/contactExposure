...
public class contactTracing {
    ...
    public List<String> ContactQuery(Query query){
        ...
        List<String> affectedPeople = metadata.selectAffectedPeople();
        ...
        for(int i=0;i<presence.getPresence().size();i++){
            ...
            if(indent != -1){
                ...
                for(int j = closestIntervalIndent; j<indexList.getIndex().get(indent).getIndexNodes().size();j++){
                    //System.out.println(closestIntervalIndent + " " + indexList.getIndex().get(indent).getIndexNodes().get(j).getStartTimeStamp() + " " + indexList.getIndex().get(indent).getIndexNodes().get(j).getEndTimeStamp());
                    if(interval.getEndTimeStamp().getTime() <= indexList.getIndex().get(indent).getIndexNodes().get(j).getStartTimeStamp().getTime()){
                        break;//searching is done
                    }
                    ...
                    else if(query.getSemanticMode() == 1){
                        sumOverlaps += overlap;
                    ...
                    if(contactPersonList.get(i).isContact()){
                        ...
                        for(int j=0;j<contactPersonList.get(i).getContactIntervals().size();j++){
                            if(query.getContactMode() == 1) {//weak{
                                System.out.println(contactPersonList.get(i).getContactIntervals().get(j).getStartTimeStamp() + " " + contactPersonList.get(i).getContactIntervals().get(j).getEndTimeStamp() + " " + contactPersonList.get(i).getContactIntervals().get(j).getRegionLabel());
                                VS.createEventNode(1,contactPersonList.get(i).getContactIntervals().get(j).getStartTimeStamp().toString(), contactPersonList.get(i).getContactIntervals().get(j).getEndTimeStamp().toString(), contactPersonList.get(i).getContactIntervals().get(j).getRegionLabel(), "null");
                            }
                            else{
                                //System.out.println(contactPersonList.get(i).getContactIntervals().get(j).getStartTimeStamp() + " " + contactPersonList.get(i).getContactIntervals().get(j).getEndTimeStamp() + " " + contactPersonList.get(i).getContactIntervals().get(j).getRegionLabel() + " " + contactPersonList.get(i).getContactIntervals().get(j).getRoomLabel());
                                VS.createEventNode(1,contactPersonList.get(i).getContactIntervals().get(j).getStartTimeStamp().toString(), contactPersonList.get(i).getContactIntervals().get(j).getEndTimeStamp().toString(), contactPersonList.get(i).getContactIntervals().get(j).getRegionLabel(), contactPersonList.get(i).getContactIntervals().get(j).getRoomLabel());
                            }
                        }
                    }
                }
                ...
                for(int i=0;i<contactPersonList.size();i++){
                    ...
                    if(contactPersonList.get(i).isContact()){
                        ...
                        for(int j=0;j<contactPersonList.get(i).getContactIntervals().size();j++){
                            if(query.getContactMode() == 1) {//weak{
                                //System.out.println(contactPersonList.get(i).getContactIntervals().get(j).getStartTimeStamp() + " " + contactPersonList.get(i).getContactIntervals().get(j).getEndTimeStamp() + " " + contactPersonList.get(i).getContactIntervals().get(j).getRegionLabel());
                                //VS.createEventNode(contactPersonList.get(i).getContactIntervals().get(j).getStartTimeStamp().toString(), contactPersonList.get(i).getContactIntervals().get(j).getEndTimeStamp().toString(), contactPersonList.get(i).getContactIntervals().get(j).getRegionLabel(), "null");
                            }
                            else{
                                //System.out.println(contactPersonList.get(i).getContactIntervals().get(j).getStartTimeStamp() + " " + contactPersonList.get(i).getContactIntervals().get(j).getEndTimeStamp() + " " + contactPersonList.get(i).getContactIntervals().get(j).getRegionLabel() + " " + contactPersonList.get(i).getContactIntervals().get(j).getRoomLabel());
                                //VS.createEventNode(contactPersonList.get(i).getContactIntervals().get(j).getStartTimeStamp().toString(), contactPersonList.get(i).getContactIntervals().get(j).getEndTimeStamp().toString(), contactPersonList.get(i).getContactIntervals().get(j).getRegionLabel(), contactPersonList.get(i).getContactIntervals().get(j).getRoomLabel());
                            }
                        }
                    }
                }
